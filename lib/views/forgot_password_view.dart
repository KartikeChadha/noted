        ...
        if (state is AuthStateForgotPassword) {
          ...
          if (state.exception != null) {
            await showErrorDialog(context,
                'We could not process your request. Please make sure youre a registered user or register yourself.');
          }
        }
      },
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  'If you forgot your password, just enter your email and we will send you a password reset email'),
              TextField(
